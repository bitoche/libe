...
CREATE SEQUENCE public.book_language_language_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.book_relation_relation_id_seq;

CREATE SEQUENCE public.book_relation_relation_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 2147483647
	START 1
...
CREATE SEQUENCE public.entry_code_code_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.in_order_book_book_id_seq;

CREATE SEQUENCE public.in_order_book_book_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 1
...
CREATE SEQUENCE public.publishing_house_publishing_house_id_seq
	...
	CACHE 1
	NO CYCLE;
-- DROP SEQUENCE public.request_books_request_id_seq;

CREATE SEQUENCE public.request_books_request_id_seq
	INCREMENT BY 1
	MINVALUE 1
	MAXVALUE 9223372036854775807
	START 1
